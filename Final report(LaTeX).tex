...
Epsilon decay was varied from 0.995, 0.9975 and 0.999 (all other parameters standard, amount of hidden layers set to 3), with every run beginning with the $\varepsilon$ = 1.
